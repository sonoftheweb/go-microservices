...
func (c *authServiceClient) Authorize(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	out := new(AuthResponse)
...
func (UnimplementedAuthServiceServer) Authorize(context.Context, *AuthRequest) (*AuthResponse, error) {
